...
def _merge_rf_shadow_fields(candidate_row: dict, scout_row: dict) -> dict:
    ...
    for k in RF_PHASE3_TEXT_FIELDS:
        out[k] = _rf_clean(candidate_row.get(k, scout_row.get(k)), "DATA_MISSING")
    for k in RF_PHASE3_NUM_FIELDS:
        out[k] = _rf_clean(candidate_row.get(k, scout_row.get(k)), 0)
    for k in RF_PHASE3_BOOL_FIELDS:
