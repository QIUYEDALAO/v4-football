...
# ===== V4 白名单常见补充 (Saudi/Russia/Poland/Czech 等) =====
TEAM_CN_V4_MISC = {
    # 沙特联
    "Al Taawon": "布赖代合作",
    "Al-Taawoun": "布赖代合作",
    ...
    "Al Riyadh": "利雅得体育",
    "Al Wehda": "麦加统一",
    "Al-Qadisiyah FC": "卡迪西亚",

    # 俄超
    "Nizhny Novgorod": "下诺夫哥罗德",
    "FC Nizhny Novgorod": "下诺夫哥罗德",
    ...
    "Rubin Kazan": "喀山红宝石",
    "Akhmat": "格罗兹尼艾卡马特",
    "Akhmat Grozny": "格罗兹尼艾卡马特",
    "Krylya Sovetov": "苏维埃之翼",
    "Orenburg": "奥伦堡",
    "Ural": "乌拉尔",
    "Fakel": "沃罗涅日火炬",
    "Baltika": "巴蒂卡",
    ...
    "Sigma Olomouc": "奥洛穆茨",
    "Bohemians 1905": "波希米亚人1905",
    "Teplice": "特普利采",
    "Pardubice": "帕尔杜比采",
    "Karvina": "卡尔维纳",
    "České Budějovice": "布杰约维采",
    "Ceske Budejovice": "布杰约维采",
}
...
def _load_external_exact_map():
    """加载人工维护的 JSON exact 映射，允许不改代码也能补充队名。"""
    ...
    try:
        ...
        if isinstance(exact, dict):
            TEAM_CN_MAP.update({str(k): str(v) for k, v in exact.items() if k and v})
    except Exception:
        pass
